...
printf "After you have created the plugin list file (\e[32;1m${PLUGINS_LIST_FILE_NAME}\e[0m), you can run the file lister script file (\e[92m${FILE_LISTER_SCRIPT_FILE_NAME}\e[0m).\n"
